...
### Task N: <most complex/outermost change>
- **Implementation:** <what to change>
- **Test:** <how to verify this specific change works before moving on>

<Use as many tasks as needed. Each task should be independently testable. Never put a task that depends on a later task before it.>
...
<Your last task should be running the `Validation Commands` to validate the feature works correctly with zero regressions.>
